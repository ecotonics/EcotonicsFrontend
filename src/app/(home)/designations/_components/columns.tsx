    ...
    },
    {
        ...
        cell: ({ row }: any) => {
            ...
            const { deleteItem, isPending, reset } = useDeleteMutation({
                endpoint: `${API_ENDPOINTS.DESIGNATION_DETAILS}${slug}/`,
                invalidateQueries: [API_ENDPOINTS.DESIGNATIONS],
                isToast: true,
            });
                ...
                <div className="text-right">
                    ...
                    >
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                                onClick={() => {
                                    router.push(`/designations/${slug}/details`);
                                }}
                            >
                                Details
                            </DropdownMenuItem>
                            ...
                            <DropdownMenuItem
                                onClick={() => {
                                    router.push(`/designations/${slug}/edit`);
                                }}
                            >
                                Edit
                            </DropdownMenuItem>
